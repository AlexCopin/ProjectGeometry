...
Enemy::Enemy(std::string id, sf::Vector2f position, Type type)
{
	...
	case Type::Triangle:
	{
		...
		{
			soundBuffers[Type::Triangle].loadFromFile(getAssetsPath() + "Sounds\\monstre1.ogg");
		}
		// isSoundLoaded = buffer_death.loadFromFile(getAssetsPath() + "Sounds\\monstre1.ogg");
	}
	break;
	case Type::Square:
	{
		...
		{
			soundBuffers[Type::Square].loadFromFile(getAssetsPath() + "Sounds\\monstre2.ogg");
		}
		// isSoundLoaded = buffer_death.loadFromFile(getAssetsPath() + "Sounds\\monstre2.ogg");
	}
	break;
	case Type::Circle:
	{
		...
		{
			soundBuffers[Type::Circle].loadFromFile(getAssetsPath() + "Sounds\\monstre3.ogg");
		}
		// isSoundLoaded = buffer_death.loadFromFile(getAssetsPath() + "Sounds\\monstre3.ogg");
	}
	break;
	case Type::Octagon:
	{
		...
		{
			soundBuffers[Type::Octagon].loadFromFile(getAssetsPath() + "Sounds\\monstre4.ogg");
		}
		// isSoundLoaded = buffer_death.loadFromFile(getAssetsPath() + "Sounds\\monstre4.ogg");
	}
	break;
	}
